    ...
    UpdateLogFileId();
        ...
        switch(NVRam_Read(EE_SAMPLE)){
          ...
          case TASK_60SEC: SampleTime = TASK_60SEC;
            break;  
          default: SampleTime = TASK_1SEC;
            break;                    
        }
   if(NVRam_Read(EE_LOGSTATUS)== OFF) SDCard.LogEnable = OFF;
   else {
         switch(SampleTime){
           case TASK_10MSEC: Loop.FastLog_Init = ON;
            break;  
           case TASK_20MSEC: Loop.FastLog_Init = ON;
            break;            
           case TASK_50MSEC: Loop.FastLog_Init = ON;
            break;   
           case TASK_100MSEC:  Loop.FastLog_Init = ON;
            break;         
           case TASK_250MSEC:  Loop.FastLog_Init = ON;
            break;
       //   case TASK_500MSEC:  Loop.FastLog_Init = ON;
       //    break;  
          default:SDCard.LogEnable = ON;
          break;
         }      
         Loop.FastLog_DelayTimer = FASTLOG_INIT_TIMER + 10;
   }
...
bool FastLog_Terminate(void){
    if(Loop.FastLog_Status == ON){  // (Loop.FastLog_Init == OFF) && 
      if(Key.Up_Press)KeyCounterFast++;
      if((Key.Left_Press) || (Key.Right_Press) || (Key.Down_Press)) KeyCounterFast = 0;
...
void DownMenuKey(void) {
  ...
  switch (MainMenu) {
    ...
    case MENU2_SUB7 : MainMenu =  MENU2_SUB6;// 
      break;
   case MENU2_SUB8 :  MainMenu =  MENU2_SUB7;//
      break;
    case MENU2_SUB9 : MainMenu =  MENU2_SUB8;// 5   
      break;     
   case MENU2_SUB10 : MainMenu =  MENU2_SUB9;// 10
      break;
...
void UpMenuKey(void) {
  ...
  switch (MainMenu) {
    ...
    case MENU2_SUB6 :  MainMenu =  MENU2_SUB7;//
      break;
    case MENU2_SUB7 :  MainMenu =  MENU2_SUB8;//
      break;
    case MENU2_SUB8 :  MainMenu =  MENU2_SUB9;
      break;
     case MENU2_SUB9 :  
      #if defined (ARDUINO_MEGA) | defined (ARDUINO_DUE)     
    ...
    case MENU2_SUB10 :  MainMenu =  MENU2_SUB11;
     ...
     case MENU2_SUB11 :  MainMenu =  MENU2_SUB12;
      break;  
     case MENU2_SUB12 :  MainMenu =  MENU2_SUB1;//
      break; 
     case MENU2_SUB13 :  
      break;  
     case MENU2_SUB14 :  
...
void EscMenuKey(void) {   
  ...
  switch (MainMenu) {
    ...
    case MENU2_SUB7 :  MainMenu =  MENU2;//
      break;
    case MENU2_SUB8 :  MainMenu =  MENU2;//
      break;
    case MENU2_SUB9 :  MainMenu =  MENU2;//
      break;
     ...
     case MENU2_SUB12 :  MainMenu =  MENU2;//
      ...
      case MENU2_SUB13 : 
        switch(KeySupport.SampleTime){     
          case TASK_10MSEC: MainMenu =  MENU2_SUB1;//
          break;          
          case TASK_20MSEC: MainMenu =  MENU2_SUB2;//
          break;           
          case TASK_50MSEC: MainMenu =  MENU2_SUB3;//
          break;          
          case TASK_100MSEC: MainMenu =  MENU2_SUB4;//
          break;         
          case TASK_250MSEC: MainMenu =  MENU2_SUB5;//
          break;          
          case TASK_500MSEC: MainMenu =  MENU2_SUB6;//
          break;
          case TASK_1SEC: MainMenu =  MENU2_SUB7;//
          break;
          case TASK_2SEC: MainMenu =  MENU2_SUB8;//
          break;
          case TASK_5SEC: MainMenu =  MENU2_SUB9;//
          break;
          case TASK_10SEC: MainMenu =  MENU2_SUB10;//
          break;
          case TASK_20SEC: MainMenu =  MENU2_SUB11;//
          break;           
          case TASK_60SEC: MainMenu =  MENU2_SUB12;//
          break;  
          default: MainMenu =  MENU_NULL; 
          break;                    
        }
...
void SD_Card_Log_NV_Menu(bool LogStatus){
    ...
    else if(Loop.FastLog_Init == ON)MainMenu =  MENU1_SUB3;
  ...
  switch (MainMenu) {
   ...
   case MENU2 : // Menu = MENU2MIN; // call the right menu according to current one
    ...
    case MENU1_SUB1 :  //SetResetLog(ON); 
        Loop.FastLog_DelayTimer = FASTLOG_INIT_TIMER;
        switch(SampleTime){
          case TASK_10MSEC:  Loop.FastLog_Init = ON;
          break;          
          case TASK_20MSEC:  Loop.FastLog_Init = ON;
          ...
          break;  
          */
          default: SDCard.LogEnable = ON; // only if not fast mode
          break;                    
        }
    ...
    case MENU1_SUB4 :   
      break;
    case MENU2_SUB1 :  if(SampleTime != TASK_10MSEC) {KeySupport.SampleTime = TASK_10MSEC; MainMenu =  MENU2_SUB13;}  
      break;
    case MENU2_SUB2 :  if(SampleTime != TASK_20MSEC) {KeySupport.SampleTime = TASK_20MSEC; MainMenu =  MENU2_SUB13;}  
      break;
    case MENU2_SUB3 :  if(SampleTime != TASK_50MSEC) {KeySupport.SampleTime = TASK_50MSEC; MainMenu =  MENU2_SUB13;}  
      break;
    case MENU2_SUB4 :  if(SampleTime != TASK_100MSEC) {KeySupport.SampleTime = TASK_100MSEC; MainMenu =  MENU2_SUB13;}  
      break;
    case MENU2_SUB5 : if(SampleTime != TASK_250MSEC) {KeySupport.SampleTime = TASK_250MSEC; MainMenu =  MENU2_SUB13;}
      break;
    case MENU2_SUB6 :  if(SampleTime != TASK_500MSEC) {KeySupport.SampleTime = TASK_500MSEC; MainMenu =  MENU2_SUB13;}
      break;
    case MENU2_SUB7 : if(SampleTime != TASK_1SEC) {KeySupport.SampleTime = TASK_1SEC; MainMenu =  MENU2_SUB13;}
      break;
    case MENU2_SUB8 : if(SampleTime != TASK_2SEC) {KeySupport.SampleTime = TASK_2SEC; MainMenu =  MENU2_SUB13;} 
      break;
    case MENU2_SUB9 :  if(SampleTime != TASK_5SEC) {KeySupport.SampleTime = TASK_5SEC; MainMenu =  MENU2_SUB13;}
      break;
    case MENU2_SUB10 : if(SampleTime != TASK_10SEC) {KeySupport.SampleTime = TASK_10SEC; MainMenu =  MENU2_SUB13;} 
      break;
    case MENU2_SUB11 :  if(SampleTime != TASK_20SEC) {KeySupport.SampleTime = TASK_20SEC; MainMenu =  MENU2_SUB13;}
      break;
    case MENU2_SUB12 : if(SampleTime != TASK_60SEC) {KeySupport.SampleTime = TASK_60SEC; MainMenu =  MENU2_SUB13;} 
      break;

       
    case MENU2_SUB13 :  
        switch(KeySupport.SampleTime){
          case TASK_10MSEC: SampleTime = TASK_10MSEC;// Loop.FastLog_Init = ON;
          break;          
          case TASK_20MSEC: SampleTime = TASK_20MSEC;// Loop.FastLog_Init = ON;
          break;          
          case TASK_50MSEC: SampleTime = TASK_50MSEC;// Loop.FastLog_Init = ON;
          break;          
          case TASK_100MSEC: SampleTime = TASK_100MSEC;// Loop.FastLog_Init = ON;
          break;
          case TASK_250MSEC: SampleTime = TASK_250MSEC; //Loop.FastLog_Init = ON;
          break;          
          case TASK_500MSEC: SampleTime = TASK_500MSEC; //Loop.FastLog_Init = ON;
          break;
          case TASK_1SEC: SampleTime = TASK_1SEC;  
          break;
          case TASK_2SEC: SampleTime = TASK_2SEC;
